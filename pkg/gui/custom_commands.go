...
func (gui *Gui) createCommandMenu(customCommands []config.CustomCommand, commandObject oscommand.CommandObject, title string, waitingStatus string) error {
...
func (gui *Gui) createCustomCommandMenu(customCommands []config.CustomCommand, commandObject oscommand.CommandObject) error {
	return gui.createCommandMenu(customCommands, commandObject, gui.Tr.CustomCommandTitle, gui.Tr.RunningCustomCommandStatus)
}

func (gui *Gui) createBulkCommandMenu(customCommands []config.CustomCommand, commandObject oscommand.CommandObject) error {
